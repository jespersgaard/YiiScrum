...
class StoryController extends Controller
{
     ...
     */
    public function actionView($id, $scrum=false)
    {
     ...
     */
    public function actionCreate($project_id, $scrum = 0)
    {
        $model = new Story;
        ...
        if (isset($_POST['Story'])) {
            ...
            if ($model->save())
                if ($scrum) {
                    $this->redirect(array('scrum/index', 'project_id' => $project_id));
                } else {
     ...
     */
    public function actionUpdate($id, $scrum=false)
    {
        $model = $this->loadModel($id);
        ...
        if (isset($_POST['Story'])) {
            ...
            if ($model->save())
                if ($scrum) {
                    $this->redirect(array('scrum/index', 'project_id' => $model->project_id));
                } else {
